...
def initialize_database():
    ...
    CREATE TABLE IF NOT EXISTS trainer_assessment_questions (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        question TEXT NOT NULL,
        option_a TEXT NOT NULL,
        option_b TEXT NOT NULL,
    ...
    # Seed exactly 50 trainer MCQ questions once.
    trainer_questions = [
        ("What is the main purpose of a learning management system?", "To manage learning and training activities", "To replace all trainers", "To manufacture hardware", "To provide internet service", "A"),
        ("Which quality is most important for an effective trainer?", "Clear communication", "Avoiding questions", "Reading without explanation", "Ignoring feedback", "A"),
        ("What should a trainer do before starting a course?", "Define learning objectives", "Skip preparation", "Avoid knowing the audience", "Remove assessments", "A"),
        ("What is formative assessment used for?", "To monitor learning during instruction", "Only to issue final certificates", "To select hardware", "To replace teaching", "A"),
        ("What is summative assessment generally used for?", "To evaluate learning at the end of instruction", "To introduce a topic", "To collect attendance only", "To design a logo", "A"),
        ("Which method encourages active participation?", "Discussion and practical activities", "One-way reading only", "No interaction", "Ignoring learners", "A"),
        ("What does feedback help learners do?", "Understand strengths and areas for improvement", "Avoid learning", "Remove objectives", "Skip practice", "A"),
        ("A good learning objective should be:", "Specific and measurable", "Vague and impossible to measure", "Unrelated to the course", "Hidden from learners", "A"),
        ("Which is an example of blended learning?", "Combining online and face-to-face learning", "Using only printed notes", "Using only a classroom board", "Using no learning resources", "A"),
        ("Why should trainers use examples?", "To connect concepts with practical situations", "To make lessons longer without purpose", "To avoid explaining concepts", "To eliminate practice", "A"),
        ("What is competency-based training focused on?", "Demonstrable knowledge and skills", "Only attendance", "Only course duration", "Only memorization", "A"),
        ("Which tool is commonly used for a live online class?", "Video conferencing software", "Calculator only", "Text editor only", "File compression only", "A"),
        ("What should a trainer do when a learner asks a relevant question?", "Address it clearly or guide the learner to the answer", "Ignore it", "Discourage questions", "End the course", "A"),
        ("Why is learner feedback valuable?", "It helps improve training quality", "It makes objectives unnecessary", "It removes the need for preparation", "It guarantees every learner passes", "A"),
        ("What is an assessment rubric?", "A set of criteria used to evaluate performance", "A course advertisement", "A password list", "A video player", "A"),
        ("Which practice improves accessibility?", "Providing clear content and suitable alternatives", "Using unreadable text", "Avoiding captions", "Using only one format", "A"),
        ("What is the purpose of a course outline?", "To organize topics and learning activities", "To hide course content", "To replace assessment", "To prevent planning", "A"),
        ("Which approach best supports different learner needs?", "Use varied explanations and activities", "Use exactly one method for everyone", "Avoid questions", "Skip practice", "A"),
        ("What does active learning require from learners?", "Participation and engagement", "Silence at all times", "No practice", "No reflection", "A"),
        ("What is the role of a trainer in competency development?", "Guide practice, feedback and improvement", "Only take attendance", "Prevent practice", "Avoid evaluation", "A"),
        ("Which is a useful presentation practice?", "Use clear structure and relevant visuals", "Fill every slide with text", "Read every word without interaction", "Avoid headings", "A"),
        ("Why should training content be reviewed periodically?", "To keep it accurate and relevant", "To make it longer", "To remove all examples", "To avoid updates", "A"),
        ("What is digital literacy?", "The ability to use digital tools effectively and responsibly", "Knowing only how to type", "Avoiding technology", "Owning a smartphone", "A"),
        ("Which action helps protect learner data?", "Use appropriate access controls and secure handling", "Share passwords publicly", "Publish personal data", "Use the same password everywhere", "A"),
        ("What is plagiarism?", "Using another person's work without proper acknowledgement", "Creating original work", "Giving credit to sources", "Taking notes", "A"),
        ("Why are learning outcomes important?", "They state what learners should be able to achieve", "They replace all teaching", "They are only for decoration", "They prevent assessment", "A"),
        ("Which is an example of experiential learning?", "Learning through practical tasks and reflection", "Only memorizing definitions", "Avoiding activities", "Reading a title only", "A"),
        ("What is peer learning?", "Learners learning with and from one another", "Only trainer-to-learner instruction", "Learning without interaction", "Independent testing only", "A"),
        ("What should a trainer do if many learners misunderstand a concept?", "Re-explain it using another suitable approach", "Blame the learners", "Skip the topic", "End the assessment", "A"),
        ("Which factor can improve learner engagement?", "Relevant activities and interaction", "Unrelated content", "No feedback", "Long pauses without purpose", "A"),
        ("What is a pre-assessment useful for?", "Understanding existing knowledge and needs", "Issuing a final certificate", "Replacing the course", "Deleting learner records", "A"),
        ("Which is a good way to handle training time?", "Prioritize objectives and plan activities", "Ignore the schedule", "Spend all time on one minor topic", "Skip objectives", "A"),
        ("What is an instructional strategy?", "A planned approach for helping learners achieve objectives", "A computer password", "A database backup", "A certificate number", "A"),
        ("Why should assessment questions align with learning objectives?", "To measure the intended learning", "To make tests random", "To avoid meaningful evaluation", "To increase unrelated content", "A"),
        ("Which is an open-ended question?", "Explain how you would solve this problem.", "Is the answer A?", "Is 5 greater than 3?", "Choose true or false.", "A"),
        ("What is continuous professional development?", "Ongoing improvement of professional knowledge and skills", "A one-time exam only", "Stopping learning after employment", "Avoiding new skills", "A"),
        ("Which behavior supports an inclusive training environment?", "Respecting different backgrounds and learning needs", "Allowing discrimination", "Ignoring participation", "Discouraging questions", "A"),
        ("What should a trainer do with assessment results?", "Use them to understand performance and guide improvement", "Hide all results permanently", "Delete them immediately", "Ignore patterns", "A"),
        ("What is a learning resource?", "Material or tool that supports learning", "Only a certificate", "Only an attendance sheet", "Only a password", "A"),
        ("Why is practical demonstration useful?", "It shows how knowledge can be applied", "It prevents skill development", "It replaces all feedback", "It removes learning objectives", "A"),
        ("What does reliable assessment mean?", "It produces consistent results under similar conditions", "It changes criteria for each learner", "It has no scoring method", "It ignores evidence", "A"),
        ("What does valid assessment mean?", "It measures what it is intended to measure", "It measures unrelated skills", "It has no objectives", "It uses random criteria", "A"),
        ("Which is a professional trainer behavior?", "Being prepared, respectful and responsive", "Arriving unprepared", "Ignoring learners", "Sharing confidential information", "A"),
        ("Why should training materials use clear language?", "To improve understanding and reduce confusion", "To make content unnecessarily complex", "To hide information", "To avoid learner participation", "A"),
        ("What is the purpose of a case study?", "To examine a realistic situation and apply concepts", "To replace all assessment", "To avoid problem solving", "To provide unrelated information", "A"),
        ("Which activity best checks practical skill?", "A hands-on task or demonstration", "Only reading a paragraph", "Looking at a title", "Signing attendance", "A"),
        ("What is reflective learning?", "Thinking about experience to improve future performance", "Repeating a task without thought", "Avoiding feedback", "Ignoring mistakes", "A"),
        ("Why should a trainer keep accurate assessment records?", "To track performance and support informed decisions", "To publish private information", "To avoid evaluation", "To replace teaching", "A"),
        ("What is the main purpose of certification after assessment?", "To recognize demonstrated achievement according to defined criteria", "To guarantee employment", "To replace future learning", "To avoid verification", "A"),
        ("What should happen when a learner does not meet an outcome?", "Provide feedback and an opportunity for improvement or re-assessment", "Automatically remove the learner", "Hide the result", "Ignore the gap", "A"),
    ]
    count = cur.execute("SELECT COUNT(*) AS c FROM trainer_assessment_questions").fetchone()["c"]
    if count == 0:
        cur.executemany("""
            INSERT INTO trainer_assessment_questions
    ...
    if request.method == "POST":
        ...
        if role == "trainee":
            ...
            conn.execute(
                ...
                (user_id, specialization, experience, skills, bio)
                VALUES (?, '', '', '', '')
                """,
                (user_id,)
            )
...
def trainer_assessment():
    ...
    questions = conn.execute("""
        SELECT *
        FROM trainer_assessment_questions
        ORDER BY id ASC
        LIMIT 50
    """).fetchall()
    ...
    if request.method == "POST":
        ...
        if percentage >= 80:
            ...
            approved = 0
            message = "Your score is below 80%. A re-test will be conducted shortly. Your trainer account remains pending approval."

        conn.execute("""
            INSERT INTO trainer_assessment_attempts
            (trainer_id, score, total, percentage, status)
            VALUES (?, ?, ?, ?, ?)
        """, (user["id"], score, total, percentage, status))
        ...
        return render_page(
            ...
            <div class=\"card\" style=\"max-width:760px;margin:50px auto;text-align:center\">
                ...
                <p class=\"small\">Course Name: <strong>MCQ Based Test for Trainer</strong></p>
                <div class=\"score\" style=\"font-size:52px;margin:25px 0\">{score}/{total}</div>
                <h2>{percentage}%</h2>
                <p>{message}</p>
                {'<a class="btn btn-primary" href="' + url_for('trainer_dashboard') + '">Go to Trainer Dashboard</a>' if approved else '<a class="btn btn-primary" href="' + url_for('trainer_assessment') + '">Take Re-test</a>'}
    ...
    <div class="container">
        <div class="page-heading">
            <div>
                ...
                <p>Course Name: <strong>MCQ Based Test for Trainer</strong></p>
            </div>
        ...
        <div class="card" style="margin-bottom:25px">
            ...
            <p class="small">This examination contains 50 multiple-choice questions. Each question carries 1 mark.</p>
            <p class="small"><strong>80% or above:</strong> Trainer account is approved automatically.</p>
            <p class="small"><strong>Below 80%:</strong> Re-test will be conducted shortly and the account remains pending.</p>
            {% if latest %}
            <p class="small"><strong>Previous attempt:</strong> {{ latest["score"] }}/{{ latest["total"] }} ({{ latest["percentage"] }}%) — {{ latest["status"] }}</p>
            {% endif %}
        </div>
        ...
        <div class="card" style="margin-bottom:18px">
            ...
            <label style="display:block;margin:12px 0"><input type="radio" name="q_{{ q['id'] }}" value="A" required> A. {{ q["option_a"] }}</label>
            <label style="display:block;margin:12px 0"><input type="radio" name="q_{{ q['id'] }}" value="B"> B. {{ q["option_b"] }}</label>
            <label style="display:block;margin:12px 0"><input type="radio" name="q_{{ q['id'] }}" value="C"> C. {{ q["option_c"] }}</label>
            <label style="display:block;margin:12px 0"><input type="radio" name="q_{{ q['id'] }}" value="D"> D. {{ q["option_d"] }}</label>
        </div>
        {% endfor %}

        <div class="card" style="text-align:center">
            <button class="btn btn-primary" type="submit" onclick="return confirm('Are you sure you want to submit the 50-question assessment?')">Submit Assessment</button>
        </div>
        </form>
    </div>
    </div>
...
def admin_trainer_assessments():
    ...
    <div class="dashboard"><div class="container">
        ...
        <thead><tr><th>Trainer</th><th>Email</th><th>Score</th><th>Percentage</th><th>Status</th><th>Account</th><th>Date</th></tr></thead>
        <tbody>
        {% for row in results %}
        <tr>
            <td>{{ row["name"] }}</td>
        ...
        {% else %}
        <tr><td colspan="7" style="text-align:center">No trainer assessment attempts yet.</td></tr>
        {% endfor %}
        </tbody></table></div></div>
    </div></div>
    """
